      ...
      <div className="bg-white shadow-md rounded-lg max-w-sm flex-1 flex flex-col">
        ...
        <div className="px-5 pb-5 flex flex-col flex-grow">
          ...
          <span className="text-3xl font-bold text-black">₱{Number(product.price).toFixed(2)}</span>
            <button onClick={() => addToCart({ name, price, image })} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add
              to cart</button>
          </div>
        </div>
      </div>
